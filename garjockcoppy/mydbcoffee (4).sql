...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th8 24, 2022 lúc 06:03 AM
...
--
-- Cơ sở dữ liệu: `mydbcoffee`
--

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `categoryz`
--
...
--
-- Đang đổ dữ liệu cho bảng `categoryz`
--
...
--
-- Cấu trúc bảng cho bảng `orderitemz`
--
...
--
-- Đang đổ dữ liệu cho bảng `orderitemz`
--
...
--
-- Đang đổ dữ liệu cho bảng `orderz`
--
...
--
-- Cấu trúc bảng cho bảng `productz`
--
...
--
-- Đang đổ dữ liệu cho bảng `productz`
--
...
--
-- Cấu trúc bảng cho bảng `reviewz`
--
...
--
-- Đang đổ dữ liệu cho bảng `reviewz`
--

INSERT INTO `reviewz` (`_id`, `rating`, `comment`, `createdAt`, `product_id`, `user_id`) VALUES
(1, 4, 'ngon lắm ạ', '2022-08-24 14:46:41', 9, 3),
(2, 5, 'mắc quá', '2022-08-08 14:46:41', 9, 3);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `rolez`
--
...
--
-- Đang đổ dữ liệu cho bảng `rolez`
--
...
--
-- Cấu trúc bảng cho bảng `shippingaddressz`
--
...
--
-- Đang đổ dữ liệu cho bảng `shippingaddressz`
--
...
--
-- Đang đổ dữ liệu cho bảng `sizez`
--
...
--
-- Đang đổ dữ liệu cho bảng `userz`
--
...
--
-- Chỉ mục cho bảng `categoryz`
--
ALTER TABLE `categoryz`
  ADD PRIMARY KEY (`_id`);

--
-- Chỉ mục cho bảng `orderitemz`
--
...
--
-- Chỉ mục cho bảng `rolez`
--
ALTER TABLE `rolez`
  ADD PRIMARY KEY (`_id`);

--
-- Chỉ mục cho bảng `shippingaddressz`
--
...
--
-- AUTO_INCREMENT cho bảng `categoryz`
--
ALTER TABLE `categoryz`
  MODIFY `_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT cho bảng `orderitemz`
--
ALTER TABLE `orderitemz`
  MODIFY `_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT cho bảng `orderz`
--
ALTER TABLE `orderz`
  MODIFY `_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT cho bảng `productz`
--
ALTER TABLE `productz`
  MODIFY `_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;

--
-- AUTO_INCREMENT cho bảng `reviewz`
--
ALTER TABLE `reviewz`
  MODIFY `_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `rolez`
--
ALTER TABLE `rolez`
  MODIFY `_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `shippingaddressz`
--
ALTER TABLE `shippingaddressz`
  MODIFY `_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT cho bảng `sizez`
--
ALTER TABLE `sizez`
...
--
-- Các ràng buộc cho bảng `orderitemz`
--
ALTER TABLE `orderitemz`
...
--
-- Các ràng buộc cho bảng `reviewz`
--
ALTER TABLE `reviewz`
...
--
-- Các ràng buộc cho bảng `shippingaddressz`
--
ALTER TABLE `shippingaddressz`
